<div class="min-h-[80vh] flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-xl shadow-sm border border-slate-200 p-8">
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-slate-900">Register your company</h2>
            <p class="mt-2 text-sm text-slate-600">
                Or <a href="/login" class="font-medium text-brand-600 hover:text-brand-500 transition-colors">sign in to existing account</a>
            </p>
        </div>
        ...
        <form wire:submit="register" class="space-y-6">
            <div>
                ...
                <div class="mt-1">
                    <input id="company_name" wire:model="company_name" type="text" required autofocus
                ...
                @error('company_name') <span class="mt-1 text-sm text-red-600">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="name" class="block text-sm font-medium text-slate-700">Your Name (Admin)</label>
                <div class="mt-1">
